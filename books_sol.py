...
print(f"1. '{book_title_01.title()}', '{book_author_01.upper()}', {str(round(book_price_01, 2)) + CURR},  - {book_category_01}")
print(f"2. '{book_title_02.title()}', '{book_author_02.upper()}', {str(round(book_price_02, 2)) + CURR},  - {book_category_02}")
print(f"3. '{book_title_03.title()}', '{book_author_03.upper()}', {str(round(book_price_03, 2)) + CURR},  - {book_category_03}")